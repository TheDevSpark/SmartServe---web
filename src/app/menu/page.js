...
// Dummy Dish Data
  const dishes = [
    ...
    },
    {
      ...
      rating: 4.9,
       badges: ["Vegetarian"],
       description:"Handmade pasta with seasonal vegetables and black truffle oil"
    },
    {
      id: 3,
      ...
      rating: 5,
      badges: ["Popular"],
      description:"Premium Wagyu beef with red wine reduction and garlic mashed potatoes"
    },
    {
      id: 4,
    ...
    },
    {
      ...
      rating: 4.7,
        badges: [],
        description:"Crispy duck breast with cherry reduction and wild rice pilaf"
    },
  ];
        ...
        {filteredDishes.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredDishes.map((dish) => (
              <DishCard key={dish.id} dish={dish} showCategory={true} showDescription={true}/>
            ))}
          </div>
        ) : (
